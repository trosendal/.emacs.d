...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org auto-org-md markdown-mode pdf-tools use-package solarized-theme popup password-store magit helm-core ess counsel)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(font-lock-comment-delimiter-face ((t (:foreground "dark olive green" :weight bold))))
 '(font-lock-comment-face ((t (:foreground "dark olive green" :slant italic :weight normal))))
